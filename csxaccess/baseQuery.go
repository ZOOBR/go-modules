...
func PrepareBaseQuery(ctx *csxhttp.Context, mode int, params map[string]string, accessManager *AccessManager) (*BaseQuery, *csxschema.SchemaTable, *string, map[string]string, int, string) {
	// values := ctx.Values()
